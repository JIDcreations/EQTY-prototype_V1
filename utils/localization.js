...
import { glossaryTermsNl } from '../data/glossaryNl';
...
const LESSON_STEP_COPY = {
  en: {
    ...
    labels: {
      ...
      lessonGlossaryResultsCount: (count) => (count === 1 ? '1 term found' : `${count} terms found`),
      part: 'Part',
      step: 'Step',
      lessonFlowPhases: {
        1: 'Concept',
    ...
    messages: {
      ...
      viewAllCardsToContinue: 'Tap each card to view the explanation',
      readyToContinue: 'Ready to continue',
      viewedCardsCount: (count, total) => `${count} of ${total} viewed`,
      chooseAnswerFirst: 'Choose an answer first',
      answerAllQuestionsToContinue: 'Answer all questions to continue',
      completeOrderToContinue: 'Complete the order to continue',
      writeShortReflectionToContinue: 'Write a short reflection to continue',
      lessonGlossaryEmptySearch: 'No matching term found. Try a simpler word.',
  ...
  nl: {
    ...
    labels: {
      ...
      lessonGlossaryResultsCount: (count) => (count === 1 ? '1 begrip gevonden' : `${count} begrippen gevonden`),
      part: 'Onderdeel',
      step: 'Stap',
      lessonFlowPhases: {
        1: 'Concept',
    ...
    messages: {
      ...
      viewAllCardsToContinue: 'Tik op elke kaart om de uitleg te bekijken',
      readyToContinue: 'Klaar om verder te gaan',
      viewedCardsCount: (count, total) => `${count} van ${total} bekeken`,
      chooseAnswerFirst: 'Kies eerst een antwoord',
      answerAllQuestionsToContinue: 'Beantwoord alle vragen om verder te gaan',
      completeOrderToContinue: 'Plaats alle stappen om verder te gaan',
      writeShortReflectionToContinue: 'Schrijf een korte reflectie om verder te gaan',
      lessonGlossaryEmptySearch: 'Geen term gevonden. Probeer een eenvoudiger woord.',
...
const ONBOARDING_COPY = {
  en: {
    ...
    login: {
      ...
      passwordPlaceholder: '********',
      passwordRequired: 'Incorrect password.',
    ...
    email: {
      ...
      emailRequired: 'Enter your email to create an account.',
      emailInvalid: 'That email looks off. Check for a typo and try again.',
      emailTypo: 'That email looks mistyped. Did you mean {email}?',
      divider: 'or',
      button: 'Create account',
  ...
  nl: {
    ...
    login: {
      ...
      passwordPlaceholder: '********',
      passwordRequired: 'Verkeerd wachtwoord.',
    ...
    email: {
      ...
      emailRequired: 'Voer je e-mail in om een account aan te maken.',
      emailInvalid: 'E-mailadres klopt niet.',
      emailTypo: 'Dit e-mailadres lijkt fout gespeld. Bedoelde je {email}?',
      divider: 'of',
...
const LESSON_RESOURCES_COPY = {
  ...
  nl: {
    ...
    noSearchResults: 'Geen bronnen gevonden voor je zoekopdracht.',
    openResource: 'Openen',
    currentLessonTag: 'Nu',
    completedTag: 'Klaar',
...
const SETTINGS_COPY = {
  en: {
    ...
    account: {
      ...
      usernameHelper: 'Shown on your EQTY profile.',
      usernameRequired: 'Enter a username to save.',
      emailLabel: 'Email address',
      emailPlaceholder: 'name@email.com',
      emailHelper: 'Used for login and support replies.',
    ...
    helpCenter: {
      ...
      emptySearchHint: 'Try a broader term or browse the topics below.',
      resultsCount: (count) => (count === 1 ? '1 guide found' : `${count} guides found`),
    ...
    changePassword: {
      ...
      confirmPasswordHelper: 'Enter the same new password twice to confirm.',
  ...
  nl: {
    ...
    account: {
      ...
      usernameHelper: 'Zichtbaar op je EQTY-profiel.',
      usernameRequired: 'Voer een gebruikersnaam in om op te slaan.',
      emailLabel: 'E-mailadres',
      emailPlaceholder: 'naam@email.com',
      emailHelper: 'Gebruikt voor inloggen en supportreacties.',
    ...
    helpCenter: {
      ...
      emptySearchHint: 'Probeer een bredere zoekterm of bekijk de onderwerpen hieronder.',
      resultsCount: (count) => (count === 1 ? '1 handleiding gevonden' : `${count} handleidingen gevonden`),
    ...
    changePassword: {
      ...
      confirmPasswordHelper: 'Voer twee keer hetzelfde nieuwe wachtwoord in ter bevestiging.',
      passwordMismatch: 'Wachtwoorden komen nog niet overeen.',
...
const GLOSSARY_COPY = {
  ...
  nl: {
    ...
    noMatches: 'Geen termen gevonden voor je zoekopdracht.',
    definition: 'Definitie',
    example: 'Voorbeeld',
