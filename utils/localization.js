...
import { glossaryTerms as baseGlossaryTerms } from '../data/glossary';
...
const LESSON_STEP_COPY = {
  en: {
    ...
    labels: {
      ...
      eqtyInsight: 'Based on your answer',
    ...
    messages: {
      ...
      reflectionQuestion: "If there's one thing you take away from this lesson, what is it?",
  ...
  nl: {
    ...
    labels: {
      ...
      eqtyInsight: 'Gebaseerd op je antwoord',
    ...
    messages: {
      ...
      reflectionQuestion: 'Als er één ding is dat je geleerd hebt uit deze les, wat is het?',
...
const HOME_COPY = {
  en: {
    ...
    deepenInterests: 'Go deeper into your interests',
    postCourseStepLabel: 'Deep dive 1',
  ...
  nl: {
    ...
    deepenInterests: 'Verdiep je in je interesses',
    postCourseStepLabel: 'Verdieping 1',
...
const LESSON_RESOURCES_COPY = {
  ...
  nl: {
    title: 'Bronnen',
    subtitle: 'Bekijk bronnen over de concepten uit je lessen',
    ...
    searchSuggestions: ["ETF's", 'Risico', 'Dividend', 'Aandelen', 'Obligaties', 'Kosten', 'Belasting'],
    topicTitles: {
...
const GLOSSARY_TERM_COPY = {
  nl: {
    mb_asset: { term: 'Vermogensbestanddeel' },
    mb_equity: { term: 'Eigen vermogen' },
    mb_market_cap: { term: 'Marktkapitalisatie' },
    mb_liquidity: { term: 'Liquiditeit' },
    mb_bid: { term: 'Biedprijs' },
    mb_ask: { term: 'Laatprijs' },
    mb_spread: { term: 'Bied-laatspread' },
    mb_volume: { term: 'Volume' },
    mb_index: { term: 'Index' },
    rr_risk: { term: 'Risico' },
    rr_return: { term: 'Rendement' },
    rr_expected_return: { term: 'Verwacht rendement' },
    rr_volatility: { term: 'Volatiliteit' },
    rr_drawdown: { term: 'Terugval' },
    rr_correlation: { term: 'Correlatie' },
    rr_beta: { term: 'Beta' },
    rr_alpha: { term: 'Alpha' },
    rr_sharpe: { term: 'Sharpe-ratio' },
    pb_diversification: { term: 'Diversificatie' },
    pb_asset_allocation: { term: 'Assetallocatie' },
    pb_rebalancing: { term: 'Herbalanceren' },
    pb_dca: { term: 'Periodiek beleggen' },
    pb_lump_sum: { term: 'Eenmalige inleg' },
    pb_position_sizing: { term: 'Positiegrootte' },
    pb_glide_path: { term: 'Glijpad' },
    pb_target_allocation: { term: 'Doelallocatie' },
    pb_portfolio_drift: { term: 'Portefeuilledrift' },
    ef_mutual_fund: { term: 'Beleggingsfonds' },
    ef_index_fund: { term: 'Indexfonds' },
    ef_active_fund: { term: 'Actief fonds' },
    ef_expense_ratio: { term: 'Kostenratio' },
    ef_nav: { term: 'Intrinsieke waarde (NAV)' },
    ef_tracking_error: { term: 'Tracking error' },
    se_stock: { term: 'Aandeel' },
    se_dividend: { term: 'Dividend' },
    se_dividend_yield: { term: 'Dividendrendement' },
    se_eps: { term: 'Winst per aandeel (EPS)' },
    se_pe: { term: 'K/W-verhouding' },
    se_pb: { term: 'Koers/boekwaarde (K/B)' },
    se_growth_stock: { term: 'Groeiaandeel' },
    se_value_stock: { term: 'Waardeaandeel' },
    se_buyback: { term: 'Aandeleninkoop' },
    se_blue_chip: { term: 'Blue chip-aandeel' },
    bi_bond: { term: 'Obligatie' },
    bi_coupon: { term: 'Coupon' },
    bi_yield: { term: 'Rendement' },
    bi_ytm: { term: 'Rendement tot vervaldag' },
    bi_interest_rate_risk: { term: 'Renterisico' },
    bi_credit_risk: { term: 'Kredietrisico' },
    ot_market_order: { term: 'Marktorder' },
    ot_limit_order: { term: 'Limietorder' },
    ot_stop_loss: { term: 'Stop-lossorder' },
    ot_stop_limit: { term: 'Stop-limitorder' },
    ot_day_order: { term: 'Dagorder' },
    ot_gtc: { term: 'Doorlopend order (GTC)' },
    ot_slippage: { term: 'Slippage' },
    ot_short_selling: { term: 'Short selling' },
    ot_margin: { term: 'Margin' },
    cf_commission: { term: 'Commissie' },
    cf_trading_fee: { term: 'Handelskost' },
    cf_management_fee: { term: 'Beheervergoeding' },
    cf_performance_fee: { term: 'Prestatievergoeding' },
    cf_custody_fee: { term: 'Bewaarvergoeding' },
    cf_fx_fee: { term: 'Wisselkost' },
    cf_spread_cost: { term: 'Spreadkost' },
    cf_entry_fee: { term: 'Instapkosten' },
    cf_exit_fee: { term: 'Uitstapkosten' },
    tr_capital_gains_tax: { term: 'Meerwaardebelasting' },
    tr_dividend_tax: { term: 'Dividendbelasting' },
    tr_withholding_tax: { term: 'Bronbelasting' },
    tr_tax_loss_harvesting: { term: 'Fiscale verliescompensatie' },
    tr_wash_sale: { term: 'Wash-sale-regel' },
    tr_tax_advantaged: { term: 'Fiscaal voordelige rekening' },
    tr_investor_protection: { term: 'Beleggersbeschermingsregeling' },
    tg_time_horizon: { term: 'Tijdshorizon' },
    tg_risk_tolerance: { term: 'Risicotolerantie' },
    tg_goal_based: { term: 'Doelgericht beleggen' },
    tg_emergency_fund: { term: 'Noodfonds' },
    tg_liquidity_needs: { term: 'Liquiditeitsbehoeften' },
    tg_capital_preservation: { term: 'Kapitaalbehoud' },
    tg_income_investing: { term: 'Inkomensbeleggen' },
    tg_growth_investing: { term: 'Groeibeleggen' },
    tg_target_date_fund: { term: 'Doeldatumfonds' },
    mr_inflation: { term: 'Inflatie' },
    mr_interest_rate: { term: 'Rente' },
    mr_central_bank: { term: 'Centrale bank' },
    mr_policy_rate: { term: 'Beleidsrente' },
    mr_yield_curve: { term: 'Rentecurve' },
    mr_gdp: { term: 'BBP' },
    mr_cpi: { term: 'Consumptieprijsindex (CPI)' },
    mr_recession: { term: 'Recessie' },
    mr_currency_risk: { term: 'Valutarisico' },
    bp_loss_aversion: { term: 'Verliesaversie' },
    bp_confirmation_bias: { term: 'Bevestigingsbias' },
    bp_anchoring: { term: 'Verankering' },
    bp_herding: { term: 'Kuddegedrag' },
    bp_recency_bias: { term: 'Recentheidsbias' },
    bp_overconfidence: { term: 'Overmoed' },
    bp_panic_selling: { term: 'Paniekverkopen' },
    bp_mental_accounting: { term: 'Mentale boekhouding' },
  },
};
...
export function getLocalizedGlossaryTerms(language, terms = baseGlossaryTerms) {
  const locale = getLocaleKey(language);
  const localizedById = GLOSSARY_TERM_COPY[locale];
  if (!localizedById) return terms;
  return terms.map((term) => {
    const override = localizedById[term.id];
